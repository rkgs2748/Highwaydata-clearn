...
public class CheckOnlineUpload_6 {
	...
	static final String userUploaddw[] = {"id","name",  
		"serviceItems","startTime","endTime","operation"};
...
//				System.out.println("array： "+array[i]);
	...
	public static String checkOnlineUpload(String key, Object obj){
	...
	public static String checkId(Object id){  //返回:1表示必填为空，2表示类型不符，3表示规则错误，4表示校验通过
		array[0] = true;
		 Id_6check check1 = new Id_6check();
