...
public class CheckRefundUpload1_25 {
	 ...
	 public static boolean [] array = {false, false,false,false,false,
		...
		static final String userUploaddw[] = {"id","type","fee","effectiveTime",
			"sectionCount","splitTime","orderNum","identification","details"};
		
		public static String checkRequiredKey(){  //9必填项
			String results = "";
	 ...
	 public static String checkRefund(String key, Object obj) throws ParseException{
	 ...
	 public static String checkId(Object id){  //返回:1表示必填为空，2表示类型不符，3表示规则错误，4表示校验通过
		 array[0] = true;
		 Id_25check checktemp=new Id_25check();
 		            ...
 		            while(it.hasNext()){
 	                     ...
 	                     if(key.equals("id")){
 	                    	 ...
 	                    	 if(value.toString().length() != 41)  return "json嵌套id值长度有误";
 	                    		 ...
 	                    		 String id_2 = value.toString().substring(39, 41);
