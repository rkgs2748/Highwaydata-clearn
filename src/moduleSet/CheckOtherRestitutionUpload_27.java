...
public class CheckOtherRestitutionUpload_27 {
	 ...
	 public static boolean [] array = {false, false,false,false,false,
		...
		static final String userUploaddw[] = {"id","fee","effectiveTime","enTollLaneId","vehicleId",
			"vehicleType","sectionCount","splitTime","details","identification","orderNum"};
		
		public static String checkRequiredKey(){  //11必填项
			    String results = "";
	 ...
	 public static String checkOtherRestitution(String key, Object obj) throws ParseException{
	 ...
	 public static String checkId(Object id){  //返回:1表示必填为空，2表示类型不符，3表示规则错误，4表示校验通过
		 array[0] = true;
		 Id_27check checktemp=new Id_27check();
